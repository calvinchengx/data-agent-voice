...
doctor: ## Check the toolchain, docker, and that the upstream stack is reachable
	...
	arch=$$(uname -m); [ "$$arch" = "x86_64" ] && printf "  \033[32mok\033[0m    linux/amd64 native\n" || printf "  \033[33mwarn\033[0m  $$arch host: the TEN image runs under emulation; expect slower ASR\n"; \
