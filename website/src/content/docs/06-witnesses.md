---
title: "What is checked, and what that is worth"
editUrl: "https://github.com/calvinchengx/data-agent-voice/edit/main/docs/06-witnesses.md"
---

159 checks run on every push. **None of them can tell you the line works** —
only a call does that, and [`parity.md`](/data-agent-voice/docs/parity/) keeps those rows red.
